...
can start these tasks by opening the command palette and select
...
docs), it can be restarted by opening the command palette and selecting
...
With the development container, you can test your custom component in Home
Assistant with step by step debugging.

You need to modify the `configuration.yaml` file in `.devcontainer` folder by
